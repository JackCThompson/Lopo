...
public class DoorBrownLeftOpen extends StaticEntity{

	public DoorBrownLeftOpen(int x, int y, Handler handler) {
		super(x, y, handler);
	...
	protected void initAnimHandler() {
		...
		animHandler.setTexture(Assets.doorBrownLeftOpen);
	}
