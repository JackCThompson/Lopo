...
public class DoorBrownRightOpen extends StaticEntity{

	public DoorBrownRightOpen(int x, int y, Handler handler) {
		super(x, y, handler);
	...
	protected void initAnimHandler() {
		...
		animHandler.setTexture(Assets.doorBrownRightOpen);
	}
