...
public class DoorGreyRightOpen extends StaticEntity{

	public DoorGreyRightOpen(int x, int y, Handler handler) {
		super(x, y, handler);
	...
	protected void initAnimHandler() {
		...
		animHandler.setTexture(Assets.doorGreyRightOpen);
	}
